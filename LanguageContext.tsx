...
const translations = {
  en: {
    ...
    help_modal_step_2_title_bookmarklet: 'Step 2: Go to Binance',
    help_modal_step_2_text_bookmarklet: "Go to the Binance Futures leaderboard page of a user you want to track.",
    help_modal_step_3_title_bookmarklet: 'Step 3: Copy Data',
    help_modal_step_3_text_bookmarklet: "Click the 'Get Binance Data' bookmark you just created. A notification will appear confirming the data has been copied to your clipboard.",
    help_modal_step_4_title_bookmarklet: 'Step 4: Paste and Process',
    help_modal_step_4_text_bookmarklet: "Come back here, paste it into the text area (Ctrl+V or Cmd+V), and click 'Process Data'.",
    ...
    bookmarklet_toast_error: 'Error fetching or copying data. See console for details.',
    bookmarklet_toast_uid_not_found: 'Error: Could not find user ID in the URL. Make sure you are on a user\'s leaderboard page.',
  ...
  ko: {
    ...
    help_modal_step_2_title_bookmarklet: '2단계: 바이낸스로 이동',
    help_modal_step_2_text_bookmarklet: "추적하려는 사용자의 바이낸스 선물 리더보드 페이지로 이동하세요.",
    help_modal_step_3_title_bookmarklet: '3단계: 데이터 복사',
    help_modal_step_3_text_bookmarklet: "방금 추가한 '데이터 가져오기' 북마크를 클릭하세요. 데이터가 클립보드에 복사되었다는 확인 알림이 나타납니다.",
    help_modal_step_4_title_bookmarklet: '4단계: 붙여넣기 및 처리',
    help_modal_step_4_text_bookmarklet: "이 앱으로 돌아와 텍스트 영역에 붙여넣기(Ctrl+V 또는 Cmd+V)하고 '데이터 처리' 버튼을 클릭하세요.",
    help_modal_close_button: '닫기',
    
    bookmarklet_button: '데이터 가져오기',
    bookmarklet_toast_success: '✅ 포지션 데이터가 클립보드에 복사되었습니다!',
    bookmarklet_toast_error: '❌ 데이터를 가져오거나 복사하는 중 오류 발생. 콘솔을 확인하세요.',
    bookmarklet_toast_uid_not_found: '❌ 오류: URL에서 사용자 ID를 찾을 수 없습니다. 사용자의 리더보드 페이지에 있는지 확인하세요.',
